...
function ActionDropdown({ onApprove, onReject, onViewDetails }) {
        ...
        >
          <div className="py-1 w-full">
            <div className="py-1 w-full">
              <Link
                to={"/"}
                className="px-4 py-2 text-sm text-indigo-600 hover:bg-indigo-50 flex items-center"
              >
            ...
            <div className="py-1 w-full">
              <Link
                to={"/"}
                className="px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 flex items-center"
              >
