        ...
        <li>
          ...
          >
            <svg
              ...
              stroke="currentColor"
            >
              {/* Your dashboard icon SVG code here */}
            </svg>
            Dashboard
          </Link>
        </li>
        <li>
          ...
          >
            <svg
              ...
              stroke="currentColor"
            >
              {/* Your add car icon SVG code here */}
            </svg>
            Add car
          </Link>
        </li>
        <li>
          ...
          >
            <svg
              ...
              stroke="currentColor"
            >
              {/* Your logout icon SVG code here */}
            </svg>
            Logout 
          </Link>
        </li>
